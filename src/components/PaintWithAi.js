...
const PaintWithAi = () => {
    ...
    //         let newHeight = containerWidth * (450 / 800);
    ...
    const onResults = ((results) => {
        ...
        if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
            ...
            const isEraserMode = fingersUp[1] === 1 && fingersUp[2] === 1 && nonEarse.every(index => fingersUp[index] === 0);
    ...
    return (
        <div className='paint-with-ai-page-container'>
            <div id="container">
                ...
                <div>
                <img id="img" src={'img/Doraemon.png'}/>
                </div>

            </div>
            <ColorPicker color={drawColorRef.current} onChangeComplete={handleColorChange} />
